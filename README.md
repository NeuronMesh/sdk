...
> Python client SDK for interacting with the core inference API - part of the [NeuronMesh](https://github.com/NeuronMesh) open-source ecosystem.
...
The `sdk` package provides the Python interface for integrating with NeuronMesh's infrastructure, designed for ease of use in both scripts and production services.
...
```bash
git clone https://github.com/NeuronMesh/sdk
cd sdk
pip install -e .
```
...
- **GitHub Issues:** [github.com/NeuronMesh/issues](https://github.com/NeuronMesh)
- **Discussions:** [github.com/NeuronMesh/discussions](https://github.com/NeuronMesh)
